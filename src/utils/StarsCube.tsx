...
// Type-only shim: three/drei's Point types may not resolve with our TS settings.
// Keep logic the same but cast the component to accept any props locally.
const AnyPoint: any = Point as any;
	...
	return (
		<Points ref={points as any}>
			...
			{flakePositions.map((pos, index) => (
				<AnyPoint key={index} position={pos} />
			))}
		</Points>
	);
}
